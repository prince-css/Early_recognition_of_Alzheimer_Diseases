...
class HanInDataset(Dataset):
    def __init__(self, dataset, dict_path, max_sent_length=30, max_word_length=35):
...
if __name__== "__main__":
    test= HanInDataset(data_path="../../dataset/data/test.csv", dict_path="../../dataset/data/glove.6B.50d.txt")
